    ...
    return (
        <section className='py-32 bg-slate-700'>
            <div className="container mx-auto">
                ...
                <div className='grid grid-cols-2 gap-1 md:gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-20'>
                    {skills?.map((skills, idx) => (
                        <div key={idx} className='shadow rounded-lg bg-white p-1 border overflow-hidden hover:scale-105 duration-200'>
